...
public class ForceField : MonoBehaviour
{
    ...
    void Update()
    {
        if (shrinking)
        {
            transform.localScale = Vector3.MoveTowards(transform.localScale, Vector3.one * targetDiameter, (shrinkDuration) * Time.deltaTime);
    ...
    void Shrink()
    {
        ...
        //make sure we don't shrink below minimum 
